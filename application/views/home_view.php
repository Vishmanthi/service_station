...
<body>
  <header>
      ...
      <h1 class="display-4 banner-heading">Welcome to <span class="text-uppercase">Auto Miraj</span><span class="display-3"></span></h1>
    ...
    <div class="container-fluid">
      ...
      <div class="row my-5">
        <div class="col-md-4 text-center">
          ...
          <p class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea hic perferendis dolor vitae sed, quae officiis exercitationem quaerat? Fugit excepturi exercitationem inventore, repellendus architecto illum!</p>
        </div>
        <div class="col-md-4 text-center">
     ...
     <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-5 text-center">
          <img src="http://localhost/service_station/assets/images/ser2.jpg" width="350" class="img-fluid camera-img">
        </div>
